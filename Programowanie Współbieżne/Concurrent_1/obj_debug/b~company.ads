...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#cd845580#;
   ...
   u00055 : constant Version_32 := 16#ebdf2801#;
   pragma Export (C, u00055, "ada__real_timeB");
   u00056 : constant Version_32 := 16#41de19c7#;
   pragma Export (C, u00056, "ada__real_timeS");
   u00057 : constant Version_32 := 16#7384e8d6#;
   pragma Export (C, u00057, "system__arith_64B");
   u00058 : constant Version_32 := 16#efa2804d#;
   pragma Export (C, u00058, "system__arith_64S");
   u00059 : constant Version_32 := 16#52c41c4b#;
   pragma Export (C, u00059, "system__taskingB");
   u00060 : constant Version_32 := 16#92b38721#;
   pragma Export (C, u00060, "system__taskingS");
   u00061 : constant Version_32 := 16#3b0b7afe#;
   pragma Export (C, u00061, "system__task_primitivesS");
   u00062 : constant Version_32 := 16#e0522444#;
   pragma Export (C, u00062, "system__os_interfaceB");
   u00063 : constant Version_32 := 16#25d7c152#;
   pragma Export (C, u00063, "system__os_interfaceS");
   u00064 : constant Version_32 := 16#cdb1cd10#;
   pragma Export (C, u00064, "system__linuxS");
   u00065 : constant Version_32 := 16#3f70ee12#;
   pragma Export (C, u00065, "system__os_constantsS");
   u00066 : constant Version_32 := 16#d7975a23#;
   pragma Export (C, u00066, "system__unsigned_typesS");
   u00067 : constant Version_32 := 16#b4921ea2#;
   pragma Export (C, u00067, "system__task_primitives__operationsB");
   u00068 : constant Version_32 := 16#74a4c38b#;
   pragma Export (C, u00068, "system__task_primitives__operationsS");
   u00069 : constant Version_32 := 16#35042ca6#;
   pragma Export (C, u00069, "system__bit_opsB");
   u00070 : constant Version_32 := 16#c30e4013#;
   pragma Export (C, u00070, "system__bit_opsS");
   u00071 : constant Version_32 := 16#903909a4#;
   pragma Export (C, u00071, "system__interrupt_managementB");
   u00072 : constant Version_32 := 16#3d6662cb#;
   pragma Export (C, u00072, "system__interrupt_managementS");
   u00073 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00073, "system__multiprocessorsB");
   u00074 : constant Version_32 := 16#85da9926#;
   pragma Export (C, u00074, "system__multiprocessorsS");
   u00075 : constant Version_32 := 16#e7299166#;
   pragma Export (C, u00075, "system__stack_checking__operationsB");
   u00076 : constant Version_32 := 16#49df1cef#;
   pragma Export (C, u00076, "system__stack_checking__operationsS");
   u00077 : constant Version_32 := 16#1530815b#;
   pragma Export (C, u00077, "system__crtlS");
   u00078 : constant Version_32 := 16#3d54d5f6#;
   pragma Export (C, u00078, "system__task_infoB");
   u00079 : constant Version_32 := 16#0fcc0405#;
   pragma Export (C, u00079, "system__task_infoS");
   u00080 : constant Version_32 := 16#1872c2a7#;
   pragma Export (C, u00080, "system__tasking__debugB");
   u00081 : constant Version_32 := 16#8c562538#;
   pragma Export (C, u00081, "system__tasking__debugS");
   u00082 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00082, "system__concat_2B");
   u00083 : constant Version_32 := 16#46a6f4a9#;
   pragma Export (C, u00083, "system__concat_2S");
   u00084 : constant Version_32 := 16#ae97ef6c#;
   pragma Export (C, u00084, "system__concat_3B");
   u00085 : constant Version_32 := 16#cb5c043f#;
   pragma Export (C, u00085, "system__concat_3S");
   u00086 : constant Version_32 := 16#c9fdc962#;
   pragma Export (C, u00086, "system__concat_6B");
   u00087 : constant Version_32 := 16#7abcf341#;
   pragma Export (C, u00087, "system__concat_6S");
   u00088 : constant Version_32 := 16#def1dd00#;
   pragma Export (C, u00088, "system__concat_5B");
   u00089 : constant Version_32 := 16#ad4fc8f4#;
   pragma Export (C, u00089, "system__concat_5S");
   u00090 : constant Version_32 := 16#3493e6c0#;
   pragma Export (C, u00090, "system__concat_4B");
   u00091 : constant Version_32 := 16#bf29e5eb#;
   pragma Export (C, u00091, "system__concat_4S");
   u00092 : constant Version_32 := 16#1eab0e09#;
   pragma Export (C, u00092, "system__img_enum_newB");
   u00093 : constant Version_32 := 16#3a71cda5#;
   pragma Export (C, u00093, "system__img_enum_newS");
   u00094 : constant Version_32 := 16#194ccd7b#;
   pragma Export (C, u00094, "system__img_unsB");
   u00095 : constant Version_32 := 16#486366d4#;
   pragma Export (C, u00095, "system__img_unsS");
   u00096 : constant Version_32 := 16#c959d75d#;
   pragma Export (C, u00096, "system__stack_usageB");
   u00097 : constant Version_32 := 16#a5188558#;
   pragma Export (C, u00097, "system__stack_usageS");
   ...
   u00100 : constant Version_32 := 16#afd62b40#;
   pragma Export (C, u00100, "ada__tagsB");
   u00101 : constant Version_32 := 16#1442fc05#;
   pragma Export (C, u00101, "ada__tagsS");
   u00102 : constant Version_32 := 16#79817c71#;
   pragma Export (C, u00102, "system__val_unsB");
   u00103 : constant Version_32 := 16#c73fb718#;
   pragma Export (C, u00103, "system__val_unsS");
   u00104 : constant Version_32 := 16#aea309ed#;
   pragma Export (C, u00104, "system__val_utilB");
   u00105 : constant Version_32 := 16#11d6b0ab#;
   pragma Export (C, u00105, "system__val_utilS");
   u00106 : constant Version_32 := 16#b7fa72e7#;
   pragma Export (C, u00106, "system__case_utilB");
   u00107 : constant Version_32 := 16#106a66dd#;
   pragma Export (C, u00107, "system__case_utilS");
   u00108 : constant Version_32 := 16#30d8d53e#;
   pragma Export (C, u00108, "ada__text_ioB");
   u00109 : constant Version_32 := 16#f792461d#;
   pragma Export (C, u00109, "ada__text_ioS");
   u00110 : constant Version_32 := 16#1358602f#;
   pragma Export (C, u00110, "ada__streamsS");
   u00111 : constant Version_32 := 16#53190229#;
   pragma Export (C, u00111, "interfaces__c_streamsB");
   u00112 : constant Version_32 := 16#3ebb5e8e#;
   pragma Export (C, u00112, "interfaces__c_streamsS");
   u00113 : constant Version_32 := 16#35bbd729#;
   pragma Export (C, u00113, "system__file_ioB");
   u00114 : constant Version_32 := 16#9f99c2b3#;
   pragma Export (C, u00114, "system__file_ioS");
   u00115 : constant Version_32 := 16#8cbe6205#;
   pragma Export (C, u00115, "ada__finalizationB");
   u00116 : constant Version_32 := 16#22e22193#;
   ...
   u00118 : constant Version_32 := 16#f28475c5#;
   pragma Export (C, u00118, "system__finalization_rootS");
   u00119 : constant Version_32 := 16#b46168d5#;
   pragma Export (C, u00119, "ada__io_exceptionsS");
   u00120 : constant Version_32 := 16#b2cb9bcf#;
   ...
   u00122 : constant Version_32 := 16#17d70f63#;
   pragma Export (C, u00122, "system__crtl__runtimeS");
   u00123 : constant Version_32 := 16#d53b6c45#;
   pragma Export (C, u00123, "system__os_libB");
   u00124 : constant Version_32 := 16#89dce9aa#;
   pragma Export (C, u00124, "system__os_libS");
   u00125 : constant Version_32 := 16#4cd8aca0#;
   pragma Export (C, u00125, "system__stringsB");
   u00126 : constant Version_32 := 16#0a9c4c91#;
   pragma Export (C, u00126, "system__stringsS");
   u00127 : constant Version_32 := 16#e8578845#;
   pragma Export (C, u00127, "system__file_control_blockS");
   u00128 : constant Version_32 := 16#91d2300e#;
   pragma Export (C, u00128, "system__finalization_mastersB");
   u00129 : constant Version_32 := 16#d783aa79#;
   pragma Export (C, u00129, "system__finalization_mastersS");
   u00130 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00130, "system__address_imageB");
   u00131 : constant Version_32 := 16#1c9a9b6f#;
   pragma Export (C, u00131, "system__address_imageS");
   u00132 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00132, "system__img_boolB");
   u00133 : constant Version_32 := 16#48af77be#;
   ...
   u00135 : constant Version_32 := 16#6ed81938#;
   ...
   u00138 : constant Version_32 := 16#3d0b17cc#;
   pragma Export (C, u00138, "system__memoryB");
   u00139 : constant Version_32 := 16#77fdba40#;
   pragma Export (C, u00139, "system__memoryS");
   u00140 : constant Version_32 := 16#1fd820b1#;
   pragma Export (C, u00140, "system__storage_pools__subpoolsB");
   u00141 : constant Version_32 := 16#951e0de9#;
   pragma Export (C, u00141, "system__storage_pools__subpoolsS");
   u00142 : constant Version_32 := 16#1777d351#;
   pragma Export (C, u00142, "system__storage_pools__subpools__finalizationB");
   u00143 : constant Version_32 := 16#12aaf1de#;
   pragma Export (C, u00143, "system__storage_pools__subpools__finalizationS");
   u00144 : constant Version_32 := 16#adffef18#;
   pragma Export (C, u00144, "semaphoresB");
   u00145 : constant Version_32 := 16#851e5fbe#;
   pragma Export (C, u00145, "semaphoresS");
   u00146 : constant Version_32 := 16#78928eb3#;
   pragma Export (C, u00146, "system__tasking__protected_objectsB");
   u00147 : constant Version_32 := 16#09cb1bb5#;
   pragma Export (C, u00147, "system__tasking__protected_objectsS");
   u00148 : constant Version_32 := 16#12b846a5#;
   pragma Export (C, u00148, "system__soft_links__taskingB");
   u00149 : constant Version_32 := 16#6ac0d6d0#;
   ...
   u00151 : constant Version_32 := 16#d832eaef#;
   pragma Export (C, u00151, "ada__exceptions__is_null_occurrenceS");
   u00152 : constant Version_32 := 16#4861433c#;
   pragma Export (C, u00152, "system__tasking__protected_objects__entriesB");
   u00153 : constant Version_32 := 16#4d64e3b6#;
   pragma Export (C, u00153, "system__tasking__protected_objects__entriesS");
   u00154 : constant Version_32 := 16#386436bc#;
   pragma Export (C, u00154, "system__restrictionsB");
   u00155 : constant Version_32 := 16#f1bbb6dc#;
   pragma Export (C, u00155, "system__restrictionsS");
   u00156 : constant Version_32 := 16#6b472777#;
   pragma Export (C, u00156, "system__tasking__initializationB");
   u00157 : constant Version_32 := 16#9468d5af#;
   pragma Export (C, u00157, "system__tasking__initializationS");
   u00158 : constant Version_32 := 16#84c1a39b#;
   pragma Export (C, u00158, "system__tasking__protected_objects__operationsB");
   u00159 : constant Version_32 := 16#a9cb954d#;
   pragma Export (C, u00159, "system__tasking__protected_objects__operationsS");
   u00160 : constant Version_32 := 16#f81293e6#;
   pragma Export (C, u00160, "system__tasking__entry_callsB");
   u00161 : constant Version_32 := 16#837d42fa#;
   pragma Export (C, u00161, "system__tasking__entry_callsS");
   u00162 : constant Version_32 := 16#b892e5ab#;
   pragma Export (C, u00162, "system__tasking__queuingB");
   u00163 : constant Version_32 := 16#5b69ac57#;
   pragma Export (C, u00163, "system__tasking__queuingS");
   u00164 : constant Version_32 := 16#d2bce054#;
   pragma Export (C, u00164, "system__tasking__utilitiesB");
   u00165 : constant Version_32 := 16#5f437348#;
   pragma Export (C, u00165, "system__tasking__utilitiesS");
   u00166 : constant Version_32 := 16#bd6fc52e#;
   pragma Export (C, u00166, "system__traces__taskingB");
   u00167 : constant Version_32 := 16#55cf3c43#;
   pragma Export (C, u00167, "system__traces__taskingS");
   u00168 : constant Version_32 := 16#da47006c#;
   pragma Export (C, u00168, "system__tasking__rendezvousB");
   u00169 : constant Version_32 := 16#592e9c02#;
   pragma Export (C, u00169, "system__tasking__rendezvousS");
   u00170 : constant Version_32 := 16#48031dbe#;
   pragma Export (C, u00170, "system__tasking__stagesB");
   u00171 : constant Version_32 := 16#dd4b61af#;
