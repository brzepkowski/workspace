        ...
        while (true) {
            ...
            for (int i = 0; i < bustersPerPlayer; i++) {
				...
				if (numberOfEntities == bustersPerPlayer && ((int[]) myBusters.get(i))[4] == 0) {
                    if (myTeamId == 0) System.out.println("MOVE " + (2*((int[])myBusters.get(i))[1]) + " " + (2*((int[]) myBusters.get(i))[2]));
					else System.out.println("MOVE " + (((int[])myBusters.get(i))[1] / 2) + " " + (((int[]) myBusters.get(i))[2] / 2));				}
				else {
