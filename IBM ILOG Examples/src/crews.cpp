...
int main(int argc, char* argv[]) {
 ...
 try {
  ...
  crews = IloIntSetVarArray(env, nCrews);
  for(i = 0; i < nCrews; i++)
  ...
  IloIntSetVarArray attributeSets(env);
  attributeSets.add(Senior);
  attributeSets.add(Junior);
  attributeSets.add(French);
  attributeSets.add(German);
  attributeSets.add(Spanish);
