// -------------------------------------------------------------- -*- C++ -*-
// File: ./examples/src/binpacking_ex3.cpp
// --------------------------------------------------------------------------
...
In this exercise, change the order of the variables. Select bins of type
green first, then bins of type blue, and then bins of type red. The scalar
product of the new bin should still be greater than or equal to the scalar
product of the previous bin. However, change the coefficients of types of
components so that they are weighted in the following descending order:
copper, wood, steel, plastic, and glass.
