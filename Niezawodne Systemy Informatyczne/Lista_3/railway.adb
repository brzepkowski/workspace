package body Railway with SPARK_Mode is
   ...
   begin
      if Route = Route_Enter_Left and Segment_State.Left = Free then
         ...
         Success := True;
      elsif Route = Route_Left_Middle and Segment_State.Left = Occupied_Standing and
        Segment_State.Middle = Free  then
         ...
         Success := True;
      elsif Route = Route_Middle_Right and Segment_State.Middle = Occupied_Standing and
        Segment_State.Right = Free then
         ...
         Success := True;
      elsif Route = Route_Right_Middle and Segment_State.Right = Occupied_Standing and
        Segment_State.Middle = Free then
         Segment_State.Right := Occupied_Moving_Left;
         Segment_State.Middle := Reserved_Moving_From_Right;
         Signal_State.Right_Middle := Green;
         Success := True;
      elsif Route = Route_Middle_Left and Segment_State.Middle = Occupied_Standing and
   ...
   is
   begin
      if Route = Route_Left_Middle and Segment_State.Left = Occupied_Moving_Right and
        Segment_State.Middle = Reserved_Moving_From_Left then
         ...
         Success := True;
      elsif Route = Route_Middle_Right and Segment_State.Middle = Occupied_Moving_Right and
        Segment_State.Right = Reserved_Moving_From_Left then
         ...
         Success := True;
      elsif Route = Route_Right_Middle and Segment_State.Right = Occupied_Moving_Left and
        Segment_State.Middle = Reserved_Moving_From_Right then
         Signal_State.Right_Middle := Red;
         Segment_State.Right := Free;
         Segment_State.Middle := Occupied_Standing;
         Success := True;
      elsif Route = Route_Middle_Left and Segment_State.Middle = Occupied_Moving_Left and
        Segment_State.Left = Reserved_Moving_From_Right then
         Signal_State.Middle_Left := Red;
         Segment_State.Middle := Free;
         Segment_State.Left := Occupied_Standing;
         Success := True;
      elsif Route = Route_Enter_Left and Segment_State.Left = Reserved_Moving_From_Left then
         Segment_State.Left := Occupied_Standing;
         Success := True;
