...
public class Main {
    ...
    public static BigInteger[] generateKeys() {
        ...
        BigInteger p = new BigInteger(256, randomGenerator);
        BigInteger q = new BigInteger(256, randomGenerator);
        while (!p.isProbablePrime(1000000)) {
            p = new BigInteger(256, randomGenerator);
        }
        while (!q.isProbablePrime(1000000)) {
            q = new BigInteger(256, randomGenerator);
        }
