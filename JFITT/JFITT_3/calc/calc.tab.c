...
{
       0,    24,    24,    25,    29,    30,    33,    38,    42,    43,
      44,    45,    47,    52,    53,    54,    55
};
#endif
...
{
       0,   256,   257,   258,    10,   259,   260,    40,    41,    43,
      45,    42,    47,    94
};
# endif
...
{
     -10,    14,   -10,   -10,   -10,   -10,    29,    -2,   -10,    18,
      34,   -10,    29,   -10,    29,    29,    29,    29,    30,   -10,
      40,    -9,    -9,     0,     0,    31,     0,   -10,   -10,    29,
      -9,    46,   -10
};
...
{
       2,     0,     1,     7,     4,     6,     0,     0,     3,     0,
       0,     8,     0,     5,     0,     0,     0,     0,     0,    15,
       0,     9,    10,    11,    12,     0,    13,    16,     7,     0,
      14,     0,    15
};
...
{
      10,    11,    16,    17,    18,    12,    20,     0,    21,    22,
      23,    24,    26,    18,     2,     0,     0,     3,     4,    30,
       5,     6,    13,    31,     7,     0,     0,    14,    15,    16,
      17,    18,     3,     3,    28,     0,     6,     6,    29,     7,
      25,     7,    19,    14,    15,    16,    17,    18,    27,    14,
      15,    16,    17,    18,    32,    14,    15,    16,    17,    18
};

static const yytype_int8 yycheck[] =
{
       6,     3,    11,    12,    13,     7,    12,    -1,    14,    15,
      16,    17,    18,    13,     0,    -1,    -1,     3,     4,    25,
       6,     7,     4,    29,    10,    -1,    -1,     9,    10,    11,
      12,    13,     3,     3,     3,    -1,     7,     7,     7,    10,
      10,    10,     8,     9,    10,    11,    12,    13,     8,     9,
...
{
       0,    15,     0,     3,     4,     6,     7,    10,    16,    17,
      17,     3,     7,     4,     9,    10,    11,    12,    13,     8,
      17,    17,    17,    17,    17,    10,    17,     8,     3,     7,
      17,    17,     8
};
...
#line 30 "calc.y" /* yacc.c:1646  */
    {	if ((yyvsp[-1]) < 0) (yyvsp[-1]) = mod((yyvsp[-1]));
			else (yyvsp[-1]) = (yyvsp[-1]) % 1234577;
			printf("\nWynik:\t%llu\n", (yyvsp[-1])); }
...
#line 38 "calc.y" /* yacc.c:1646  */
    { if ((yyvsp[0]) >= 0) (yyval) = (yyvsp[0]) % 1234577;
			else if ((yyvsp[0]) < 0) (yyval) = mod((yyvsp[0]));
			printf("%llu ", (yyval));}
...
#line 42 "calc.y" /* yacc.c:1646  */
    { (yyval) = mod((yyvsp[0])); printf("%llu ", (yyval));	}
#line 1242 "calc.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 43 "calc.y" /* yacc.c:1646  */
    { (yyval) = ((yyvsp[-2]) + (yyvsp[0])) % 1234577; printf("+ ");	}
...
#line 47 "calc.y" /* yacc.c:1646  */
    { if ((yyvsp[0]) > 0) (yyval) = (yyvsp[-2]) * euklides((yyvsp[0]));
			else if ((yyvsp[0]) == 0) printf("Błąd: Dzielenie przez 0.\n");
			else (yyval) = (yyvsp[-2]) * euklides(mod((yyvsp[0]))); 
			printf("/ ");}
...
#line 52 "calc.y" /* yacc.c:1646  */
    { (yyval) = intpow((yyvsp[-2]), (yyvsp[0])); printf("^ ");}
#line 1275 "calc.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 53 "calc.y" /* yacc.c:1646  */
    { (yyval) = intpow(euklides((yyvsp[-3])), abs((yyvsp[0]))); printf("^ ");}
