...
import eu.jpereira.trainings.designpatterns.creational.builder.json.JSONBodyReportBuilder;
import eu.jpereira.trainings.designpatterns.creational.builder.model.Customer;
import eu.jpereira.trainings.designpatterns.creational.builder.model.Report;
import eu.jpereira.trainings.designpatterns.creational.builder.model.ReportAssembler;
import eu.jpereira.trainings.designpatterns.creational.builder.model.SaleEntry;
import eu.jpereira.trainings.designpatterns.creational.builder.model.SoldItem;
import eu.jpereira.trainings.designpatterns.creational.builder.xml.XMLBodyReportBuilder;
...
public class ReportAssemblerTest {
	...
	public void testAssembleJSONReportBody() {
		...
		JSONBodyReportBuilder builder = new JSONBodyReportBuilder();
	...
	public void testAssembleXMLReportBody() {
		...
		assembler.setSaleEntry(createDummySaleEntry());
		XMLBodyReportBuilder builder = new XMLBodyReportBuilder();
		Report report = assembler.getReport(builder);
	...
	public void testAssembleHTMLReportBody() {
		...
		assembler.setSaleEntry(createDummySaleEntry());
		HTMLBodyReportBuilder builder = new HTMLBodyReportBuilder();
		Report report = assembler.getReport(builder);
